...
namespace JiraReporting.JiraClient
{
    ...
    /// </summary>
    public class JiraClient : IProjectDomain, IWorkDomain, IUserDomain, ISessionDomain, IIssueDomain, IFilterDomain, IAttachmentDomain, IServerDomain, IAgileDomain, IGreenhopperDomain, IDisposable
    {
        ...
        public JiraClient(Uri baseUri, IHttpSettings httpSettings = null)
        {
